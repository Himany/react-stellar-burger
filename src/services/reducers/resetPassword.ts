...
import { TForgotPassword } from '../types/type.js';

type TResetPasswordState = {
  forgotPasData: TForgotPassword;
  resetPasData: TForgotPassword;
  errorData: TForgotPassword;
  forgotPasRequest: boolean;
  forgotPasFailed: boolean;
  resetPasRequest: boolean;
  resetPasFailed: boolean;
}
