...
function Feed() {
  ...
  const ordersReadyNumber = [];
  const ordersWorkNumber = [];

  if (feed.orders.orders) {
          ...
          <div className={styles.container}>
            ...
            <div className={styles.statisticsContainer}>
              ...
              <div>
                ...
                <p className={`text text_type_digits-large ${styles.textShadow}`}>{feed.orders.total}</p>
              </div>
              <div>
                <p className="text text_type_main-medium">Выполнено за сегодня:</p>
                <p className={`text text_type_digits-large ${styles.textShadow}`}>{feed.orders.totalToday}</p>
              </div>
            </div>
          </div>
        </>
